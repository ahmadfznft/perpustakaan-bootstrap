    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        <a href="master-role.php" class="text-decoration-none" style="color: black;">
                            <h5 class="card-title">Daftar Role</h5>
                            <p class="card-text">Jumlah role: <?php echo $roleCount; ?></p>
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 mb-3">
                <div class="card">
                    <div class="card-body">
                        <a href="master-user.php" class="text-decoration-none" style="color: black;">
                            <h5 class="card-title">Daftar Pengguna</h5>
                            <p class="card-text">Jumlah pengguna: <?php echo $userCount; ?></p>
                        </a>
                    </div>
                </div>
            </div>

...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2025 at 01:46 PM
...
CREATE TABLE `peminjaman` (
  ...
  `StatusPeminjaman` enum('Menunggu Konfirmasi','Buku Dipinjam','Buku Dikembalikan','Ditolak','Pengembalian Telat') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(13, 2, 3, '2025-02-18', '2025-02-20', 'Ditolak');
...
(6, 3, 'uusan', 'a6e8c26fdaeff2c0230f864ccbc610d2', 'uus@gmail.com', 'Uus Aja', 'dimana aja');

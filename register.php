                    ...
                    <div class="card border-0 shadow">
                        <div class="card-body">
                            ...
                            <form action="cekregister.php" method="POST">
                                ...
                                <input type="password" name="pass" id="pass" class="form-control my-4 py-2" placeholder="Password" required />
                                <input type="email" name="email" id="email" class="form-control my-4 py-2" placeholder="Email" required />
                                <input type="text" name="fullname" id="fullname" class="form-control my-4 py-2" placeholder="Full Name" required />
                                <input type="text" name="alamat" id="alamat" class="form-control my-4 py-2" placeholder="Address" required />
                                <div class="text-center mt-3">
                                    <button type="submit" name="submit" class="btn btn-primary">Register</button>
                                </div>
                                <div class="text-center mt-3">
                                    <span>Already have an account? <a href="login.php" class="nav-link d-inline p-0">Login Here!</a></span>
                                </div>
                            </form>
                        </div>
                    </div>
